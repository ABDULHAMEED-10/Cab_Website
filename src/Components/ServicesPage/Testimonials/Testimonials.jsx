            ...
            <li>
              <div className="slide">
                <div className="user-info">
                  ...
                  <div>
                    <h3>Amelia</h3>
                    <span>Aylesyone, UK</span>
                    <div>
                      <p>
                        Aylestone Cabs is one of the best travel coompanies, I
              ...
              <div className="slide">
                <div className="user-info">
                  ...
                  <div>
                    ...
                    <div>
                      <p>
                        Choosing Aylestone Cabs for transportation was a great
                  ...
                  <div>
                    ...
                    <div>
                      <p>
                        ...
                        Cabs. The driver was very friendly and respecting.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="slide">
                <div className="user-info">
                  ...
                  <div>
                    ...
                    <div>
                      <p>
                        Travelling with Aylestone cabs feels like travelling in
                        own vehicle.
                      </p>
                    </div>
                  </div>
